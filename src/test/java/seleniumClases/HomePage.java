...
public class HomePage{
  ...
  //Pick Airport
    ...
    private final String woDestination = ".flights-searchbox__form-inputs-group-location .mb-checkbox__mark";
...
//Search
	...
	public HomePage() {
         ...
         this.airport = new Airport (driver,origin,destination,wait,options,woDestination);
	...
	public void selectNoDestination() {
		...
		this.airport.exploreWithoutDestination();
